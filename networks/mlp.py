...
class PotentialNet(nn.Module):
    ...
    def forward(self, input_array, time_array, *args, **kwargs):
        ...
        out_state = (self.state_time_net(extended_input) * input_array).sum(-1, keepdim=True) 
    ...
    def score(self, input_array, time_array, clip=False, *args, **kwargs):
        ...
        with torch.enable_grad():
            return torch.clip(torch.autograd.grad(self.forward(input_array, time_array, clip,).sum(), input_array, create_graph=True)[0], -self.clip, self.clip)
